    ...
    render() {
        ...
        return (
            <g {...getObjectAttributes(object)}>
                ...
                <path cursor="pointer" onMouseDown={self.onRotateMouseDown.bind(self)} transform={'translate(' + rotateIcon.x + ' ' + rotateIcon.y +')'} stroke="#ffffff" strokeWidth="0.2" d="M5.1,0.2L4.4,0.8c-0.1,0.1-0.1,0.2,0,0.3l1.1,1.1C4.2,2.1,2.8,2.5,1.7,3.5c-2,1.8-2.1,4.9-0.3,6.8
